...
本文档提供 AItrader 项目中 GitHub Actions 工作流、CodeQL 安全扫描和 CI/CD 相关的完整指南。
...
AItrader 使用多个自动化工作流来确保代码质量和安全性。
...
```yaml
- description: AItrader custom security and quality checks
- queries: '.'
...
3. 配置:
   - **Token name**: `AItrader Code Scanning Reader`
...
| **AI Deep Analysis** | `scripts/analyze_commits_ai.py` | DeepSeek AI 语义分析 (可选) |
