        ...
        <div className="bg-background/70 backdrop-blur-xl border border-border/40 rounded-2xl shadow-lg shadow-black/5">
          <div className="flex h-14 items-center justify-between px-4">
            ...
            {mounted && (
              <div ref={metricsRef} className="hidden lg:flex items-center gap-2 relative">
                ...
                {metricsExpanded && (
                  <div className="absolute top-full right-0 mt-2 w-64 bg-background/95 backdrop-blur-xl border border-border/50 rounded-xl shadow-xl p-3 space-y-2">
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden py-4 border-t border-border/30">
              {/* Navigation Links */}
              <nav className="flex flex-col gap-1 mb-4 px-2">
                {navItems.map((item) => {
                  const isActive = router.pathname === item.href;
                  return (
                    <Link
              ...
              {mounted && (
                <div className="border-t border-border/30 pt-4 mb-4 px-2">
              ...
              {/* Bottom Actions */}
              <div className="flex items-center justify-between px-2 pt-4 border-t border-border/30">
