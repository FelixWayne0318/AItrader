  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
      ...
      <MetricCard
        ...
        subValue={data.profit_factor >= 1.5 ? 'Excellent' : data.profit_factor >= 1 ? 'Good' : 'Poor'}
        color={data.profit_factor >= 1.5 ? 'profit' : data.profit_factor >= 1 ? 'warning' : 'loss'}
        index={1}
        icon={
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <MetricCard
        ...
        subValue={data.sharpe_ratio >= 2 ? 'Excellent' : data.sharpe_ratio >= 1 ? 'Good' : 'Review needed'}
        color={data.sharpe_ratio >= 2 ? 'profit' : data.sharpe_ratio >= 1 ? 'primary' : 'warning'}
        index={2}
        icon={
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
