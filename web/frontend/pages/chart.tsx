          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Card className="border-border/50">
                ...
                <CardContent className="space-y-3">
                  {/* Bull Analysis */}
                  <div className="p-2 rounded-lg bg-[hsl(var(--profit))]/5 border border-[hsl(var(--profit))]/20">
                    <div className="flex items-center gap-2 mb-1">
                      <TrendingUp className="h-3 w-3 text-[hsl(var(--profit))]" />
                      <span className="text-xs font-medium text-[hsl(var(--profit))]">Bull Case</span>
                    </div>
                    <p className="text-xs text-muted-foreground line-clamp-3">
                      {aiAnalysis?.bull_analysis || "Loading analysis..."}
                    </p>
                  </div>

                  {/* Bear Analysis */}
                  <div className="p-2 rounded-lg bg-[hsl(var(--loss))]/5 border border-[hsl(var(--loss))]/20">
                    <div className="flex items-center gap-2 mb-1">
                      <TrendingDown className="h-3 w-3 text-[hsl(var(--loss))]" />
                      <span className="text-xs font-medium text-[hsl(var(--loss))]">Bear Case</span>
                    </div>
                    <p className="text-xs text-muted-foreground line-clamp-3">
                      {aiAnalysis?.bear_analysis || "Loading analysis..."}
                    </p>
                  </div>
                  ...
                  <div className="p-2 rounded-lg bg-primary/5 border border-primary/20">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-medium text-primary">Judge Decision</span>
                    </div>
                    <p className="text-xs text-muted-foreground line-clamp-3">
                      {aiAnalysis?.judge_reasoning || "Awaiting analysis..."}
                    </p>
                  </div>
                </CardContent>
              </Card>
