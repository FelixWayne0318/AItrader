...
async def create_demo_signal_data():
    """Create demo signal data for testing - DISABLED IN PRODUCTION"""
    # v3.8: Demo endpoints disabled to prevent fake data in production
    # All data should come from real trading bot signals
    raise HTTPException(
        status_code=403,
        detail="Demo endpoint disabled. Real signals are generated by the trading bot."
    )
...
async def create_demo_notification_data():
    """Create demo notification data for testing - DISABLED IN PRODUCTION"""
    # v3.8: Demo endpoints disabled to prevent fake data in production
    # All notifications should come from real trading events
    raise HTTPException(
        status_code=403,
        detail="Demo endpoint disabled. Real notifications are generated by trading events."
    )
